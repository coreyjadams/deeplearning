...
weights = '/home/coradam/deeplearning/resnet/resnet_argoneut_iter_10000.caffemodel'
...
plt.savefig("/home/coradam/deeplearning/resnet/figures/classifier_nue_scores.pdf",format='pdf')
plt.savefig("/home/coradam/deeplearning/resnet/figures/classifier_nue_scores.png",format='png')
plt.show()
