...
output_directories.update({'nu_data' : '/home/coradam/neutrino_supera/nova_net/'})
output_directories.update({'anu_data' : '/home/coradam/antineutrino_supera/nova_net/'})
output_directories.update({'anu_sim' : '/home/coradam/anu_sim_supera/nova_net/'})
...
def writeCfgFile(inputFile):
  ...
  out_file = "/home/coradam/deeplearning/cfg/process.cfg"
...
def processFile(inputFile, data_type):
  ...
  outTree = ROOT.TTree('nova_net_cnn_tree', 'results tree' )
...
def main():
  ...
  types = ['anu_sim','nu_data','anu_data']
